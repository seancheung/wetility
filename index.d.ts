...
declare global {
   ...
   * @param options
   */
  function App(options: Partial<App.Options>): App
  namespace App {
  ...
  interface App extends App.BaseOptions {}
   ...
   * @param options
   */
  function getApp(options?: getApp.Options): App
  namespace getApp {
    interface Options {
      /**
   ...
   * @param options
   */
  function Page(options: Partial<Page.Options>): Page
  namespace Page {
    interface BaseOptions {
      /**
       * 页面的初始数据
  ...
  interface Page extends Page.BaseOptions {
    /**
   ...
   * @param options
   */
  function Component(options: Partial<Component.Options>): Component
  namespace Component {
  ...
  interface Component {
    ...
    triggerEvent(
      name: string,
      detail: any,
      options: Component.EventOptions
    ): void
    /**
   ...
   * @param options
   */
  function Behavior(options: Partial<Behavior.Options>): Behavior
  namespace Behavior {
    interface Options extends Component.Options<Behavior> {}
  }
  interface Behavior extends Component {}
...
declare namespace WeChat {
  ...
  type WrappedFunc = (opts?: Record<string, any>) => Bluebird<any>
  /**
   ...
   */
  function promisify(func: WeChatFunc, context?: any): WrappedFunc
  /**
